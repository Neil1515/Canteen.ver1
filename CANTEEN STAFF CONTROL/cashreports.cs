...
{
    public partial class cashreports : UserControl
    {
        ...
        private void cashreports_Load(object sender, EventArgs e)
        {
        ...
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    string query = "SELECT * FROM cashpaymentbl WHERE CAST(datetime AS DATE) = @selectedDate";
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        string totalCashQuery = "SELECT SUM(amount) FROM cashpaymentbl WHERE CAST(datetime AS DATE) = @selectedDate";
